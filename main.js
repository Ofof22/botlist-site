...
client.user.setPresence({ activity: { type: 'WATCHING', name: 'wynexbotlistt.glitch.me' }, status: "idle" });
})
...
client.channels.cache.get(channels.votes).send("Bu aya ait tüm oylar silinmiştir.")
